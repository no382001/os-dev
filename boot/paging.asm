%define PAGE_DIR_ADDR         0x20000
%define PAGE_TABLE_IDENTITY   0x30000
%define PAGE_TABLE_KERNEL     0x40000

%define KERNEL_PHYS_START     0x10000
