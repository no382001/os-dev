...
GDB = gdb
LD = ld -m elf_i386
CFLAGSNO = -fno-pie -nostdlib -fno-builtin -nodefaultlibs -nostartfiles -Wno-error=comment -Wno-error=unused-variable -Wno-error=unused-parameter -Wno-error=unused-function #-Wno-error=pointer-arith
